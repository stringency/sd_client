...
// 固定SD参数
  ...
  //       Uri.parse('http://127.0.0.1:8000/api/1.0/txt2img/'),
  //       headers: {'Content-Type': 'application/json'},
  //       body: jsonEncode(finalParams), // 发送参数
  //     );
  ...
  //         context,
  //         MaterialPageRoute(
  //           builder: (context) => Txt2ImgsResultTmp(txt2ImgsParams: resultData),
  //         ),
  //       ).then((_) {
  //         // 重新初始化参数
  //         setState(() {
  ...
  //         SnackBar(content: Text('生成失败，请重试')),
  //       );
  //     }
  //   } catch (e) {
  //     ScaffoldMessenger.of(context).showSnackBar(
